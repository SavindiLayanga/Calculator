...
/*********************************************/
class Demo{
    public static class MyCalculator extends Frame
    {
...
//set Co-ordinates for Operator Buttons
    ...
    static class MyDigitButton extends Button implements ActionListener
    {
        MyCalculator cl;
    ...
    static class MyOperatorButton extends Button implements ActionListener
    {
        MyCalculator cl;
...
//cl.number=temp;
    ...
    static class MyMemoryButton extends Button implements ActionListener
    {
        MyCalculator cl;
    ...
    static class MySpecialButton extends Button implements ActionListener
    {
        MyCalculator cl;
